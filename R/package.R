...
#'   SplitDataFrameList abort alert alertInfo alertWarning as_tibble
#'   as.DataFrame camelCase complete.cases dl export head import initDir lapply
#'   leftJoin makeNames mapGenesToRownames mapHumanOrthologs markdownHeader
#'   mcols mcols<- melt metadata metadata<- methodFunction na.omit order
