...
params:
  ...
  # 1. Wald test statistic ("stat").
  # 2. Shrunken LFC ("log2FoldChange").
  gsea_value: "stat"
  ...
  # Number of pathways (both directions) to include in plots.
  n_pathways: 10
  
  rdata_dir: !r file.path("rds", Sys.Date())
...
assignAndSaveData(
    name = paste(name, "ranked_list", sep = "_"),
    object = ranked_list,
    dir = params$rdata_dir
)
```
...
```{r export}
export(fgsea, dir = params$output_dir)
```
...
```{r h-plot-gsea-table, results="asis"}
plotGSEATable(
    object = fgsea,
    geneSet = "h",
    alpha = params$alpha,
...
```{r h-plot-enrichment, results="asis"}
plotEnrichment(
    object = fgsea,
    geneSet = "h",
    alpha = params$alpha,
...
```{r c1-plot-gsea-table, results="asis"}
plotGSEATable(
    object = fgsea,
    geneSet = "c1",
    alpha = params$alpha,
...
```{r c1-plot-enrichment, results="asis"}
plotEnrichment(
    object = fgsea,
    geneSet = "c1",
    alpha = params$alpha,
...
```{r c2-plot-gsea-table, results="asis"}
plotGSEATable(
    object = fgsea,
    geneSet = "c2",
    alpha = params$alpha,
...
```{r c2-plot-enrichment, results="asis"}
plotEnrichment(
    object = fgsea,
    geneSet = "c2",
    alpha = params$alpha,
...
```{r c3-plot-gsea-table, results="asis"}
plotGSEATable(
    object = fgsea,
    geneSet = "c3",
    alpha = params$alpha,
...
```{r c3-plot-enrichment, results="asis"}
plotEnrichment(
    object = fgsea,
    geneSet = "c3",
    alpha = params$alpha,
...
```{r c4-plot-gsea-table, results="asis"}
plotGSEATable(
    object = fgsea,
    geneSet = "c4",
    alpha = params$alpha,
...
```{r c4-plot-enrichment, results="asis"}
plotEnrichment(
    object = fgsea,
    geneSet = "c4",
    alpha = params$alpha,
...
```{r c5-plot-gsea-table, results="asis"}
plotGSEATable(
    object = fgsea,
    geneSet = "c5",
    alpha = params$alpha,
...
```{r c5-plot-enrichment, results="asis"}
plotEnrichment(
    object = fgsea,
    geneSet = "c5",
    alpha = params$alpha,
...
```{r c6-plot-gsea-table, results="asis"}
plotGSEATable(
    object = fgsea,
    geneSet = "c6",
    alpha = params$alpha,
...
```{r c6-plot-enrichment, results="asis"}
plotEnrichment(
    object = fgsea,
    geneSet = "c6",
    alpha = params$alpha,
...
```{r c7-plot-gsea-table, results="asis"}
plotGSEATable(
    object = fgsea,
    geneSet = "c7",
    alpha = params$alpha,
...
```{r c7-plot-enrichment, results="asis"}
plotEnrichment(
    object = fgsea,
    geneSet = "c7",
    alpha = params$alpha,
