---
params:
  title: "Gene set enrichment analysis using fgsea"
  ...
  # Using Wald test statistic ("stat") by default.
  # Shrunken LFC ("log2FoldChange") also acceptable.
  gsea_value: "stat"
...
topTables(gsea, geneSet = "h", alpha = params$alpha)
```

## Plot GSEA table {.tabset}

```{r h_plot_gsea_table, results="asis"}
plotGSEATable(gsea, geneSet = "h", alpha = params$alpha)
```

## Plot enrichment {.tabset}

```{r h_plot_enrichment, results="asis"}
plotEnrichment(gsea, geneSet = "h", alpha = params$alpha)
```
...
topTables(gsea, geneSet = "c1", alpha = params$alpha)
```

## Plot GSEA table {.tabset}

```{r c1_plot_gsea_table, results="asis"}
plotGSEATable(gsea, geneSet = "c1", alpha = params$alpha)
```

## Plot enrichment {.tabset}

```{r c1_plot_enrichment, results="asis"}
plotEnrichment(gsea, geneSet = "c1", alpha = params$alpha)
```
...
topTables(gsea, geneSet = "c2", alpha = params$alpha)
```

## Plot GSEA table {.tabset}

```{r c2_plot_gsea_table, results="asis"}
plotGSEATable(gsea, geneSet = "c2", alpha = params$alpha)
```

## Plot enrichments {.tabset}

```{r c2_plot_enrichment, results="asis"}
plotEnrichment(gsea, geneSet = "c2", alpha = params$alpha)
```
...
topTables(gsea, geneSet = "c3", alpha = params$alpha)
```

## Plot GSEA table {.tabset}

```{r c3_plot_gsea_table, results="asis"}
plotGSEATable(gsea, geneSet = "c3", alpha = params$alpha)
```

## Plot enrichments {.tabset}

```{r c3_plot_enrichment, results="asis"}
plotEnrichment(gsea, geneSet = "c3", alpha = params$alpha)
```
...
topTables(gsea, geneSet = "c4", alpha = params$alpha)
```

## Plot GSEA table {.tabset}

```{r c4_plot_gsea_table, results="asis"}
plotGSEATable(gsea, geneSet = "c4", alpha = params$alpha)
```

## Plot enrichments {.tabset}

```{r c4_plot_enrichment, results="asis"}
plotEnrichment(gsea, geneSet = "c4", alpha = params$alpha)
```
...
topTables(gsea, geneSet = "c5", alpha = params$alpha)
```

## Plot GSEA table {.tabset}

```{r c5_plot_gsea_table, results="asis"}
plotGSEATable(gsea, geneSet = "c5", alpha = params$alpha)
```

## Plot enrichments {.tabset}

```{r c5_plot_enrichment, results="asis"}
plotEnrichment(gsea, geneSet = "c5", alpha = params$alpha)
```
...
topTables(gsea, geneSet = "c6", alpha = params$alpha)
```

## Plot GSEA table {.tabset}

```{r c6_plot_gsea_table, results="asis"}
plotGSEATable(gsea, geneSet = "c6", alpha = params$alpha)
```

## Plot enrichments {.tabset}

```{r c6_plot_enrichment, results="asis"}
plotEnrichment(gsea, geneSet = "c6", alpha = params$alpha)
```
...
topTables(gsea, geneSet = "c7", alpha = params$alpha)
```

## Plot GSEA table {.tabset}

```{r c7_plot_gsea_table, results="asis"}
plotGSEATable(gsea, geneSet = "c7", alpha = params$alpha)
```

## Plot enrichments {.tabset}

```{r c7_plot_enrichment, results="asis"}
plotEnrichment(gsea, geneSet = "c7", alpha = params$alpha)
```
